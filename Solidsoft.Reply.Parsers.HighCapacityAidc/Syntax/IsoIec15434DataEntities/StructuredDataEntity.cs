...
///   A structured data entity in a barcode
/// </summary>
public class StructuredDataEntity : IDataEntity
{
    /// <summary>
    ...
    {
        Format = format;
        Release = int.TryParse(release, out var releaseInt) ? releaseInt : 0;
        SubRelease = int.TryParse(subRelease, out var subReleaseInt) ? subReleaseInt : 0;
        Data = data;
        Title = title;
